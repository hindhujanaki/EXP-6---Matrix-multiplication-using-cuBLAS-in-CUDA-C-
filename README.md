...
int main() {
    ...
    for (int s = 0; s < numSizes; s++) {
        int size = sizes[s];
        printf("Running matrix multiplication for size: %d x %d\\n", size, size);
...
# OUTPUT:
<img width="1720" height="317" alt="image" src="https://github.com/user-attachments/assets/bc984924-75a1-4e74-a803-4764aa6b2df6" />
